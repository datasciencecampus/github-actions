...
def test_tag_for_sha_ignores_aliases_and_selects_highest_stable_version():
    def runner(command, **kwargs):
        return SimpleNamespace(
            returncode=0,
            stdout="latest\n1.2.3\nv1.10.0\nv1.10.0-rc.1\n",
    ...
    assert GitHubClient(runner=runner).tag_for_sha("https://github.com/example/hook", "abc") == "v1.10.0"
